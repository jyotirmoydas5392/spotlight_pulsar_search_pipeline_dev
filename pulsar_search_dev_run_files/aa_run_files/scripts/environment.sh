...
#export ASTRO_ACCELERATE_REPOSITORY_PATH=/lustre_archive/apps/tdsoft/pulsar_search_aa_versions/astro-accelerate_fixed_2dhs_ver
export ASTRO_ACCELERATE_REPOSITORY_PATH=/lustre_archive/apps/tdsoft/aa.psr
